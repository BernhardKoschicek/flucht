        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="img_container">
                    ...
                    filename=value['filepath'])}" alt="{value['text']}">
                </div>
            </div>
...
pictures_exhibition = {
    ...
    'kuk_maschinengewehr': {
        ...
        'text': _('maschinengewher_lawoczne'),
    ...
    'ansicht_oberhollabrunn1910': {
        ...
        'text': _('ansicht_oberhollabrunn1910'),
    ...
    'lagertor_oberhollabrunn1916': {
        ...
        'text': _('lagertor_oberhollabrunn1916'),
